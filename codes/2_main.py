...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='BLA_10k', choices=['mnist', 'fashion-mnist', 'celebA', 'epidermal', 'PFC', 'CPU', 'HIP', 'NAC', 'VTA', "BLA_10k", "CPU_10k", "HIP_10k", "NAC_10k", "PFC_10k", "VTA_10k"],
    ...
    parser.add_argument('--gex_size', type=int, default=1595, help='gex_size; gene expression size of data')
